...
android {
    namespace = "dev.rgkit.rhythmengine"
    compileSdk = 35
...
description = "Learns the user's weekly rhythm: best time to notify, next expected open, expected session length and churn risk."
